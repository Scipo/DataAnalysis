...
1.	Questions:
  ...
  - How the company to increase its own profits using their old customers.
  - How can your insights drive business decisions? 
  - Based on the answer of the question one we can provide an insight how to convert casual ridders into annual members. 
2.	Key tasks 
  - Identify the business task how to convert casual ridders into annual members. 
  - Consider key stakeholders – management.
